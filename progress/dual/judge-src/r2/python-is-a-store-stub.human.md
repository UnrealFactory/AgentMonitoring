...
web-address form `file:///C:/...`. Hand it the plain Windows form instead and it refuses
with `ERR_UNSUPPORTED_ESM_URL_SCHEME` — its way of saying the address does not start with
a prefix it recognises.
