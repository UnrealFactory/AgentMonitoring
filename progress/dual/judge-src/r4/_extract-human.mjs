// Round-4 prep helper: writes each sampled record's CURRENT human area verbatim
// from the CLI's --json output into progress/dual/judge-src/r4/<id>.human.md
import { execFileSync } from "node:child_process";
import { writeFileSync } from "node:fs";

const CLI = "C:/Code/AgentMonitoring/target/release/agentmon.exe";
const OUT = "C:/Code/AgentMonitoring/progress/dual/judge-src/r4";
