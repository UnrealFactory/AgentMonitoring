...
/* The per-agent activity rollup (`AgentRow` / `agentRows`) lived here until the owner cut
   the dashboard's agents table (2026-08-27): everything it counted, the feed and the
   boards already say. */
